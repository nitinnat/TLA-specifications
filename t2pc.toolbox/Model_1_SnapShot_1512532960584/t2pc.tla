...
ConsistentRM ==  
 ...
 cs == (ConsistentTM \/ ConsistentBTM)
 \*ConsistentBTMnotEnabled == ~BTMENABLE 
 \* ConsistentRM has to be satisfied in all cases, however both ConsistentTM and ConsistentBTM will
 \*not be true at the same time. Hence their disjunction is taken.
